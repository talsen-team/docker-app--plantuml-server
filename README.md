# docker-app: plantuml-server

![GitHub tag (latest by date)](https://img.shields.io/github/tag-date/talsen-team/docker-app--plantuml-server.svg?style=for-the-badge)
[![Docker Automated build](https://img.shields.io/docker/cloud/automated/talsenteam/docker-plantuml-server.svg?style=for-the-badge)](//hub.docker.com/r/talsenteam/docker-plantuml-server/)
[![Docker Pulls](https://img.shields.io/docker/pulls/talsenteam/docker-plantuml-server.svg?style=for-the-badge)](//hub.docker.com/r/talsenteam/docker-plantuml-server/)
[![Docker Build Status](https://img.shields.io/docker/cloud/build/talsenteam/docker-plantuml-server.svg?style=for-the-badge)](//hub.docker.com/r/talsenteam/docker-plantuml-server/)

The server application plantuml-server ready to run inside a docker container.

## how to use

To easily experiment with plantuml-server, the following pre-requisites are preferred:
...
Any docker-compose--* tasks refer to the default [dockerfile](docker/server--plantuml-server/default.docker) and [docker-compose](docker-compose/server--plantuml-server/default.docker-compose) configuration if required for command execution.
